...
<div style="text-align:right"><em>This page automagically generated by alphabet.xsl</em></div>
...
<xsl:template match="alphabet">
	...
	<ul>
	<li>Training file: <xsl:value-of select="train"/></li>
