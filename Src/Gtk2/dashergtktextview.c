...
#include "gtkinclude/gtkmarshalers.h"
#include "gtkinclude/gtkintl.h"
#include "gtkinclude/gtktextutil.h"
...
#include "gtk/gtksizegroup.h"          /* FIXME http://bugzilla.gnome.org/show_bug.cgi?id=72258 */
#include "gtk/gtkwindow.h"
#include "dashergtktextview.h"
#include "dashergtktextviewalias.h"
 ...
 * dasher_gtk_text_view_value_changed() and goes like this:
 ...
 *     jumping to the dasher_gtk_text_view_value_changed() code path
...
#define SCREEN_WIDTH(widget) text_window_get_width (DASHER_GTK_TEXT_VIEW (widget)->text_window)
#define SCREEN_HEIGHT(widget) text_window_get_height (DASHER_GTK_TEXT_VIEW (widget)->text_window)
...
static void dasher_gtk_text_view_init                 (DasherGtkTextView      *text_view);
static void dasher_gtk_text_view_class_init           (DasherGtkTextViewClass *klass);
static void dasher_gtk_text_view_destroy              (GtkObject        *object);
static void dasher_gtk_text_view_finalize             (GObject          *object);
static void dasher_gtk_text_view_set_property         (GObject         *object,
						guint            prop_id,
						const GValue    *value,
						GParamSpec      *pspec);
static void dasher_gtk_text_view_get_property         (GObject         *object,
						guint            prop_id,
						GValue          *value,
						GParamSpec      *pspec);
static void dasher_gtk_text_view_size_request         (GtkWidget        *widget,
                                                GtkRequisition   *requisition);
static void dasher_gtk_text_view_size_allocate        (GtkWidget        *widget,
                                                GtkAllocation    *allocation);
static void dasher_gtk_text_view_realize              (GtkWidget        *widget);
static void dasher_gtk_text_view_unrealize            (GtkWidget        *widget);
static void dasher_gtk_text_view_style_set            (GtkWidget        *widget,
                                                GtkStyle         *previous_style);
static void dasher_gtk_text_view_direction_changed    (GtkWidget        *widget,
                                                GtkTextDirection  previous_direction);
static void dasher_gtk_text_view_grab_notify          (GtkWidget        *widget,
					        gboolean         was_grabbed);
static void dasher_gtk_text_view_state_changed        (GtkWidget        *widget,
					        GtkStateType      previous_state);

static gint dasher_gtk_text_view_event                (GtkWidget        *widget,
                                                GdkEvent         *event);
static gint dasher_gtk_text_view_key_press_event      (GtkWidget        *widget,
                                                GdkEventKey      *event);
static gint dasher_gtk_text_view_key_release_event    (GtkWidget        *widget,
                                                GdkEventKey      *event);
static gint dasher_gtk_text_view_button_press_event   (GtkWidget        *widget,
                                                GdkEventButton   *event);
static gint dasher_gtk_text_view_button_release_event (GtkWidget        *widget,
                                                GdkEventButton   *event);
static gint dasher_gtk_text_view_focus_in_event       (GtkWidget        *widget,
                                                GdkEventFocus    *event);
static gint dasher_gtk_text_view_focus_out_event      (GtkWidget        *widget,
                                                GdkEventFocus    *event);
static gint dasher_gtk_text_view_motion_event         (GtkWidget        *widget,
                                                GdkEventMotion   *event);
static gint dasher_gtk_text_view_expose_event         (GtkWidget        *widget,
                                                GdkEventExpose   *expose);
static void dasher_gtk_text_view_draw_focus           (GtkWidget        *widget);
static gboolean dasher_gtk_text_view_focus            (GtkWidget        *widget,
                                                GtkDirectionType  direction);
static void dasher_gtk_text_view_select_all           (GtkWidget        *widget,
                                                gboolean          select);


/* Source side drag signals */
static void dasher_gtk_text_view_drag_begin       (GtkWidget        *widget,
                                            GdkDragContext   *context);
static void dasher_gtk_text_view_drag_end         (GtkWidget        *widget,
                                            GdkDragContext   *context);
static void dasher_gtk_text_view_drag_data_get    (GtkWidget        *widget,
                                            GdkDragContext   *context,
                                            GtkSelectionData *selection_data,
                                            guint             info,
                                            guint             time);
static void dasher_gtk_text_view_drag_data_delete (GtkWidget        *widget,
                                            GdkDragContext   *context);

/* Target side drag signals */
static void     dasher_gtk_text_view_drag_leave         (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  guint             time);
static gboolean dasher_gtk_text_view_drag_motion        (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  gint              x,
                                                  gint              y,
                                                  guint             time);
static gboolean dasher_gtk_text_view_drag_drop          (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  gint              x,
                                                  gint              y,
                                                  guint             time);
static void     dasher_gtk_text_view_drag_data_received (GtkWidget        *widget,
                                                  GdkDragContext   *context,
                                                  gint              x,
                                                  gint              y,
                                                  GtkSelectionData *selection_data,
...
static void dasher_gtk_text_view_set_scroll_adjustments (DasherGtkTextView   *text_view,
                                                  GtkAdjustment *hadj,
                                                  GtkAdjustment *vadj);
static gboolean dasher_gtk_text_view_popup_menu         (GtkWidget     *widget);

static void dasher_gtk_text_view_move_cursor       (DasherGtkTextView           *text_view,
                                             GtkMovementStep        step,
                                             gint                   count,
                                             gboolean               extend_selection);
static void dasher_gtk_text_view_page_horizontally (DasherGtkTextView          *text_view,
                                             gint                  count,
                                             gboolean              extend_selection);
static void dasher_gtk_text_view_move_viewport     (DasherGtkTextView           *text_view,
                                             GtkScrollStep          step,
                                             gint                   count);
static void dasher_gtk_text_view_set_anchor       (DasherGtkTextView           *text_view);
static void dasher_gtk_text_view_scroll_pages     (DasherGtkTextView           *text_view,
                                            gint                   count,
                                            gboolean               extend_selection);
static void dasher_gtk_text_view_scroll_hpages    (DasherGtkTextView           *text_view,
                                            gint                   count,
                                            gboolean               extend_selection);
static void dasher_gtk_text_view_insert_at_cursor (DasherGtkTextView           *text_view,
                                            const gchar           *str);
static void dasher_gtk_text_view_delete_from_cursor (DasherGtkTextView           *text_view,
                                              GtkDeleteType          type,
                                              gint                   count);
static void dasher_gtk_text_view_backspace        (DasherGtkTextView           *text_view);
static void dasher_gtk_text_view_cut_clipboard    (DasherGtkTextView           *text_view);
static void dasher_gtk_text_view_copy_clipboard   (DasherGtkTextView           *text_view);
static void dasher_gtk_text_view_paste_clipboard  (DasherGtkTextView           *text_view);
static void dasher_gtk_text_view_toggle_overwrite (DasherGtkTextView           *text_view);
static void dasher_gtk_text_view_move_focus       (DasherGtkTextView           *text_view,
                                            GtkDirectionType       direction_type);
static void dasher_gtk_text_view_unselect         (DasherGtkTextView           *text_view);

static void     dasher_gtk_text_view_validate_onscreen     (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_get_first_para_iter   (DasherGtkTextView        *text_view,
                                                     GtkTextIter        *iter);
static void     dasher_gtk_text_view_update_layout_width       (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_set_attributes_from_style (DasherGtkTextView        *text_view,
                                                         GtkTextAttributes *values,
                                                         GtkStyle           *style);
static void     dasher_gtk_text_view_ensure_layout          (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_destroy_layout         (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_check_keymap_direction (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_reset_im_context       (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_start_selection_drag   (DasherGtkTextView        *text_view,
                                                      const GtkTextIter  *iter,
                                                      GdkEventButton     *event);
static gboolean dasher_gtk_text_view_end_selection_drag     (DasherGtkTextView        *text_view,
                                                      GdkEventButton     *event);
static void     dasher_gtk_text_view_start_selection_dnd    (DasherGtkTextView        *text_view,
                                                      const GtkTextIter  *iter,
                                                      GdkEventMotion     *event);
static void     dasher_gtk_text_view_check_cursor_blink     (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_pend_cursor_blink      (DasherGtkTextView        *text_view);
static void     dasher_gtk_text_view_stop_cursor_blink      (DasherGtkTextView        *text_view);

static void     dasher_gtk_text_view_value_changed                (GtkAdjustment *adj,
							    DasherGtkTextView   *view);
static void     dasher_gtk_text_view_commit_handler               (GtkIMContext  *context,
							    const gchar   *str,
							    DasherGtkTextView   *text_view);
static void     dasher_gtk_text_view_commit_text                  (DasherGtkTextView   *text_view,
                                                            const gchar   *text);
static void     dasher_gtk_text_view_preedit_changed_handler      (GtkIMContext  *context,
							    DasherGtkTextView   *text_view);
static gboolean dasher_gtk_text_view_retrieve_surrounding_handler (GtkIMContext  *context,
							    DasherGtkTextView   *text_view);
static gboolean dasher_gtk_text_view_delete_surrounding_handler   (GtkIMContext  *context,
							    gint           offset,
							    gint           n_chars,
							    DasherGtkTextView   *text_view);

static void dasher_gtk_text_view_mark_set_handler       (GtkTextBuffer     *buffer,
                                                  const GtkTextIter *location,
                                                  GtkTextMark       *mark,
                                                  gpointer           data);
static void dasher_gtk_text_view_get_cursor_location    (DasherGtkTextView       *text_view,
						  GdkRectangle      *pos);
static void dasher_gtk_text_view_get_virtual_cursor_pos (DasherGtkTextView       *text_view,
                                                  gint              *x,
                                                  gint              *y);
static void dasher_gtk_text_view_set_virtual_cursor_pos (DasherGtkTextView       *text_view,
                                                  gint               x,
                                                  gint               y);

static GtkAdjustment* get_hadjustment            (DasherGtkTextView       *text_view);
static GtkAdjustment* get_vadjustment            (DasherGtkTextView       *text_view);

static void dasher_gtk_text_view_do_popup               (DasherGtkTextView       *text_view,
						  GdkEventButton    *event);

static void dasher_gtk_text_view_queue_scroll           (DasherGtkTextView   *text_view,
                                                  GtkTextMark   *mark,
                                                  gdouble        within_margin,
                                                  gboolean       use_align,
                                                  gdouble        xalign,
...
static gboolean dasher_gtk_text_view_flush_scroll         (DasherGtkTextView *text_view);
static void     dasher_gtk_text_view_update_adjustments   (DasherGtkTextView *text_view);
static void     dasher_gtk_text_view_invalidate           (DasherGtkTextView *text_view);
static void     dasher_gtk_text_view_flush_first_validate (DasherGtkTextView *text_view);

static void dasher_gtk_text_view_update_im_spot_location (DasherGtkTextView *text_view);

/* Container methods */
static void dasher_gtk_text_view_add    (GtkContainer *container,
                                  GtkWidget    *child);
static void dasher_gtk_text_view_remove (GtkContainer *container,
                                  GtkWidget    *child);
static void dasher_gtk_text_view_forall (GtkContainer *container,
...
typedef struct _DasherGtkTextViewChild DasherGtkTextViewChild;

struct _DasherGtkTextViewChild
{
  GtkWidget *widget;
  ...
  DasherGtkTextWindowType type;
  gint x;
  gint y;
};

static DasherGtkTextViewChild* text_view_child_new_anchored      (GtkWidget          *child,
							    GtkTextChildAnchor *anchor,
							    GtkTextLayout      *layout);
static DasherGtkTextViewChild* text_view_child_new_window        (GtkWidget          *child,
							    DasherGtkTextWindowType   type,
							    gint                x,
							    gint                y);
static void              text_view_child_free              (DasherGtkTextViewChild   *child);
static void              text_view_child_set_parent_window (DasherGtkTextView        *text_view,
							    DasherGtkTextViewChild   *child);
...
static DasherGtkTextWindow *text_window_new             (DasherGtkTextWindowType  type,
                                                   GtkWidget         *widget,
                                                   gint               width_request,
                                                   gint               height_request);
static void           text_window_free            (DasherGtkTextWindow     *win);
static void           text_window_realize         (DasherGtkTextWindow     *win,
                                                   GdkWindow         *parent);
static void           text_window_unrealize       (DasherGtkTextWindow     *win);
static void           text_window_size_allocate   (DasherGtkTextWindow     *win,
                                                   GdkRectangle      *rect);
static void           text_window_scroll          (DasherGtkTextWindow     *win,
                                                   gint               dx,
                                                   gint               dy);
static void           text_window_invalidate_rect (DasherGtkTextWindow     *win,
                                                   GdkRectangle      *rect);
static void           text_window_invalidate_cursors (DasherGtkTextWindow  *win);

static gint           text_window_get_width       (DasherGtkTextWindow     *win);
static gint           text_window_get_height      (DasherGtkTextWindow     *win);
...
GType
dasher_gtk_text_view_get_type (void)
{
  ...
  if (our_type == 0)
    {
      ...
      {
	sizeof (DasherGtkTextViewClass),
	NULL,		/* base_init */
	NULL,		/* base_finalize */
	(GClassInitFunc) dasher_gtk_text_view_class_init,
	NULL,		/* class_finalize */
	NULL,		/* class_data */
	sizeof (DasherGtkTextView),
	0,		/* n_preallocs */
	(GInstanceInitFunc) dasher_gtk_text_view_init,
      };

      our_type = g_type_register_static (GTK_TYPE_CONTAINER, "DasherGtkTextView",
					 &our_info, 0);
    }
...
dasher_gtk_text_view_class_init (DasherGtkTextViewClass *klass)
{
   ...
   */
  gobject_class->set_property = dasher_gtk_text_view_set_property;
  gobject_class->get_property = dasher_gtk_text_view_get_property;

  object_class->destroy = dasher_gtk_text_view_destroy;
  gobject_class->finalize = dasher_gtk_text_view_finalize;

  widget_class->realize = dasher_gtk_text_view_realize;
  widget_class->unrealize = dasher_gtk_text_view_unrealize;
  widget_class->style_set = dasher_gtk_text_view_style_set;
  widget_class->direction_changed = dasher_gtk_text_view_direction_changed;
  widget_class->grab_notify = dasher_gtk_text_view_grab_notify;
  widget_class->state_changed = dasher_gtk_text_view_state_changed;
  widget_class->size_request = dasher_gtk_text_view_size_request;
  widget_class->size_allocate = dasher_gtk_text_view_size_allocate;
  widget_class->event = dasher_gtk_text_view_event;
  widget_class->key_press_event = dasher_gtk_text_view_key_press_event;
  widget_class->key_release_event = dasher_gtk_text_view_key_release_event;
  widget_class->button_press_event = dasher_gtk_text_view_button_press_event;
  widget_class->button_release_event = dasher_gtk_text_view_button_release_event;
  widget_class->focus_in_event = dasher_gtk_text_view_focus_in_event;
  widget_class->focus_out_event = dasher_gtk_text_view_focus_out_event;
  widget_class->motion_notify_event = dasher_gtk_text_view_motion_event;
  widget_class->expose_event = dasher_gtk_text_view_expose_event;
  widget_class->focus = dasher_gtk_text_view_focus;
  
  widget_class->drag_begin = dasher_gtk_text_view_drag_begin;
  widget_class->drag_end = dasher_gtk_text_view_drag_end;
  widget_class->drag_data_get = dasher_gtk_text_view_drag_data_get;
  widget_class->drag_data_delete = dasher_gtk_text_view_drag_data_delete;

  widget_class->drag_leave = dasher_gtk_text_view_drag_leave;
  widget_class->drag_motion = dasher_gtk_text_view_drag_motion;
  widget_class->drag_drop = dasher_gtk_text_view_drag_drop;
  widget_class->drag_data_received = dasher_gtk_text_view_drag_data_received;

  widget_class->popup_menu = dasher_gtk_text_view_popup_menu;
  
  container_class->add = dasher_gtk_text_view_add;
  container_class->remove = dasher_gtk_text_view_remove;
  container_class->forall = dasher_gtk_text_view_forall;

  klass->move_cursor = dasher_gtk_text_view_move_cursor;
  klass->page_horizontally = dasher_gtk_text_view_page_horizontally;
  klass->set_anchor = dasher_gtk_text_view_set_anchor;
  klass->insert_at_cursor = dasher_gtk_text_view_insert_at_cursor;
  klass->delete_from_cursor = dasher_gtk_text_view_delete_from_cursor;
  klass->backspace = dasher_gtk_text_view_backspace;
  klass->cut_clipboard = dasher_gtk_text_view_cut_clipboard;
  klass->copy_clipboard = dasher_gtk_text_view_copy_clipboard;
  klass->paste_clipboard = dasher_gtk_text_view_paste_clipboard;
  klass->toggle_overwrite = dasher_gtk_text_view_toggle_overwrite;
  klass->move_focus = dasher_gtk_text_view_move_focus;
  klass->set_scroll_adjustments = dasher_gtk_text_view_set_scroll_adjustments;
  ...
  signals[MOVE_CURSOR] = 
    g_signal_new ("move_cursor",
		  ...
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, move_cursor),
		  NULL, NULL, 
  ...
  signals[PAGE_HORIZONTALLY] =
    g_signal_new ("page_horizontally",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, page_horizontally),
		  NULL, NULL,
  ...
  signals[MOVE_VIEWPORT] =
    _gtk_binding_signal_new ("move_viewport",
			     G_OBJECT_CLASS_TYPE (gobject_class),
			     G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
			     G_CALLBACK (dasher_gtk_text_view_move_viewport),
			     NULL, NULL,
  ...
  signals[SET_ANCHOR] =
    g_signal_new ("set_anchor",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, set_anchor),
		  NULL, NULL,
  ...
  signals[INSERT_AT_CURSOR] =
    g_signal_new ("insert_at_cursor",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, insert_at_cursor),
		  NULL, NULL,
  ...
  signals[DELETE_FROM_CURSOR] =
    g_signal_new ("delete_from_cursor",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, delete_from_cursor),
		  NULL, NULL,
		  _gtk_marshal_VOID__ENUM_INT,
		  G_TYPE_NONE, 2,
  ...
  signals[BACKSPACE] =
    g_signal_new ("backspace",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, backspace),
		  NULL, NULL,
		  _gtk_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);
  ...
  signals[CUT_CLIPBOARD] =
    g_signal_new ("cut_clipboard",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, cut_clipboard),
		  NULL, NULL,
		  _gtk_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);
  ...
  signals[COPY_CLIPBOARD] =
    g_signal_new ("copy_clipboard",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, copy_clipboard),
		  NULL, NULL,
		  _gtk_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);
  ...
  signals[PASTE_CLIPBOARD] =
    g_signal_new ("paste_clipboard",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, paste_clipboard),
		  NULL, NULL,
		  _gtk_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);
  ...
  signals[TOGGLE_OVERWRITE] =
    g_signal_new ("toggle_overwrite",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, toggle_overwrite),
		  NULL, NULL,
		  _gtk_marshal_VOID__VOID,
		  G_TYPE_NONE, 0);
  ...
  signals[MOVE_FOCUS] =
    g_signal_new ("move_focus",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, move_focus),
		  NULL, NULL,
  ...
  signals[SET_SCROLL_ADJUSTMENTS] =
    g_signal_new ("set_scroll_adjustments",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, set_scroll_adjustments),
		  NULL, NULL,
  ...
  signals[POPULATE_POPUP] =
    g_signal_new ("populate_popup",
		  G_OBJECT_CLASS_TYPE (gobject_class),
		  G_SIGNAL_RUN_LAST,
		  G_STRUCT_OFFSET (DasherGtkTextViewClass, populate_popup),
		  NULL, NULL,
  ...
  signals[SELECT_ALL] =
    _gtk_binding_signal_new ("select_all",
			     ...
			     G_SIGNAL_RUN_LAST | G_SIGNAL_ACTION,
			     G_CALLBACK (dasher_gtk_text_view_select_all),
			     NULL, NULL,
...
dasher_gtk_text_view_init (DasherGtkTextView *text_view)
{
  ...
  g_signal_connect (text_view->im_context, "commit",
                    G_CALLBACK (dasher_gtk_text_view_commit_handler), text_view);
  g_signal_connect (text_view->im_context, "preedit_changed",
 		    G_CALLBACK (dasher_gtk_text_view_preedit_changed_handler), text_view);
  g_signal_connect (text_view->im_context, "retrieve_surrounding",
 		    G_CALLBACK (dasher_gtk_text_view_retrieve_surrounding_handler), text_view);
  g_signal_connect (text_view->im_context, "delete_surrounding",
 		    G_CALLBACK (dasher_gtk_text_view_delete_surrounding_handler), text_view);

  text_view->cursor_visible = TRUE;

  text_view->accepts_tab = TRUE;

  text_view->text_window = text_window_new (DASHER_GTK_TEXT_WINDOW_TEXT,
                                            widget, 200, 200);
  ...
  //XXXfrederik
  dasher_gtk_text_view_set_cursor_visible(text_view,TRUE);
}

/**
 * dasher_gtk_text_view_new:
 *
 * Creates a new #DasherGtkTextView. If you don't call dasher_gtk_text_view_set_buffer()
 * before using the text view, an empty default buffer will be created
 * for you. Get the buffer with dasher_gtk_text_view_get_buffer(). If you want
 * to specify your own buffer, consider dasher_gtk_text_view_new_with_buffer().
 *
 * Return value: a new #DasherGtkTextView
 **/
GtkWidget*
dasher_gtk_text_view_new (void)
{
  return g_object_new (DASHER_GTK_TYPE_TEXT_VIEW, NULL);
}

/**
 * dasher_gtk_text_view_new_with_buffer:
 * @buffer: a #GtkTextBuffer
 *
 * Creates a new #DasherGtkTextView widget displaying the buffer
 * @buffer. One buffer can be shared among many widgets.
 * @buffer may be NULL to create a default buffer, in which case
 * this function is equivalent to dasher_gtk_text_view_new(). The
 ...
 **/
GtkWidget*
dasher_gtk_text_view_new_with_buffer (GtkTextBuffer *buffer)
{
  DasherGtkTextView *text_view;

  text_view = (DasherGtkTextView*)dasher_gtk_text_view_new ();

  dasher_gtk_text_view_set_buffer (text_view, buffer);

  return GTK_WIDGET (text_view);
}

/**
 * dasher_gtk_text_view_set_buffer:
 * @text_view: a #DasherGtkTextView
 * @buffer: a #GtkTextBuffer
 *
 * Sets @buffer as the buffer being displayed by @text_view. The previous
 * buffer displayed by the text view is unreferenced, and a reference is
 * added to @buffer. If you owned a reference to @buffer before passing it
 * to this function, you must remove that reference yourself; #DasherGtkTextView
 * will not "adopt" it.
 *
 **/
void
dasher_gtk_text_view_set_buffer (DasherGtkTextView   *text_view,
                          GtkTextBuffer *buffer)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
  ...
  if (text_view->buffer != NULL)
    {
      ...
      while (tmp_list != NULL)
        {
          DasherGtkTextViewChild *vc = tmp_list->data;
      ...
      g_signal_handlers_disconnect_by_func (text_view->buffer,
					    dasher_gtk_text_view_mark_set_handler,
					    text_view);
  ...
  if (buffer != NULL)
    {
      ...
      g_signal_connect (text_view->buffer, "mark_set",
			G_CALLBACK (dasher_gtk_text_view_mark_set_handler), text_view);
  ...
  dasher_gtk_text_view_invalidate (text_view);
}

static GtkTextBuffer*
get_buffer (DasherGtkTextView *text_view)
{
  if (text_view->buffer == NULL)
    {
      GtkTextBuffer *b;
      b = gtk_text_buffer_new (NULL);
      dasher_gtk_text_view_set_buffer (text_view, b);
      g_object_unref (b);
    }
...
/**
 * dasher_gtk_text_view_get_buffer:
 * @text_view: a #DasherGtkTextView
 *
 ...
 **/
GtkTextBuffer*
dasher_gtk_text_view_get_buffer (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), NULL);

  return get_buffer (text_view);
}

/**
 * dasher_gtk_text_view_get_iter_at_location:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 ...
 * dasher_gtk_text_view_window_to_buffer_coords().
 *
 **/
void
dasher_gtk_text_view_get_iter_at_location (DasherGtkTextView *text_view,
                                    GtkTextIter *iter,
                                    gint         x,
                                    gint         y)
{
  ...
  dasher_gtk_text_view_ensure_layout (text_view);
...
/**
 * dasher_gtk_text_view_get_iter_at_position:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 * @trailing: 
 * @x: x position, in buffer coordinates
 ...
 * dasher_gtk_text_view_window_to_buffer_coords().
 *
 * Note that this is diffferent from dasher_gtk_text_view_get_iter_at_location(),
 ...
 **/
void
dasher_gtk_text_view_get_iter_at_position (DasherGtkTextView *text_view,
				    GtkTextIter *iter,
				    gint        *trailing,
				    gint         x,
				    gint         y)
...
/**
 * dasher_gtk_text_view_get_iter_location:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 ...
 * dasher_gtk_text_view_buffer_to_window_coords() to convert these
 * coordinates to coordinates for one of the windows in the text view.
 *
 **/
void
dasher_gtk_text_view_get_iter_location (DasherGtkTextView       *text_view,
                                 const GtkTextIter *iter,
...
/**
 * dasher_gtk_text_view_get_line_yrange:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 ...
 * convert to window coordinates with dasher_gtk_text_view_buffer_to_window_coords().
 *
 **/
void
dasher_gtk_text_view_get_line_yrange (DasherGtkTextView       *text_view,
                               const GtkTextIter *iter,
                               gint              *y,
                               gint              *height)
{
...
/**
 * dasher_gtk_text_view_get_line_at_y:
 * @text_view: a #DasherGtkTextView
 ...
 * window coordinates with dasher_gtk_text_view_window_to_buffer_coords().
 * If non-%NULL, @line_top will be filled with the coordinate of the top
 * edge of the line.
 **/
void
dasher_gtk_text_view_get_line_at_y (DasherGtkTextView *text_view,
...
/**
 * dasher_gtk_text_view_scroll_to_iter:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 ...
 * consider using dasher_gtk_text_view_scroll_to_mark() which saves a point
 * to be scrolled to after line validation.
 *
 * Return value: %TRUE if scrolling occurred
 **/
gboolean
dasher_gtk_text_view_scroll_to_iter (DasherGtkTextView   *text_view,
                              GtkTextIter   *iter,
                              gdouble        within_margin,
                              gboolean       use_align,
                              gdouble        xalign,
                              gdouble        yalign)
{
  ...
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
...
static void
cancel_pending_scroll (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_queue_scroll (DasherGtkTextView   *text_view,
                            GtkTextMark   *mark,
                            gdouble        within_margin,
                            gboolean       use_align,
                            gdouble        xalign,
...
static gboolean
dasher_gtk_text_view_flush_scroll (DasherGtkTextView *text_view)
{
  GtkTextIter iter;
  GtkTextPendingScroll *scroll;
  gboolean retval;
  ...
  dasher_gtk_text_view_update_adjustments (text_view);
  
  retval = dasher_gtk_text_view_scroll_to_iter (text_view,
                                         &iter,
...
static void
dasher_gtk_text_view_set_adjustment_upper (GtkAdjustment *adj, gdouble upper)
{  
  if (upper != adj->upper)
    {
...
static void
dasher_gtk_text_view_update_adjustments (DasherGtkTextView *text_view)
{
  ...
  if (text_view->width != width || text_view->height != height)
    {
      ...
      dasher_gtk_text_view_set_adjustment_upper (get_hadjustment (text_view),
                                          MAX (SCREEN_WIDTH (text_view), width));
      dasher_gtk_text_view_set_adjustment_upper (get_vadjustment (text_view),
...
static void
dasher_gtk_text_view_update_layout_width (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_update_im_spot_location (DasherGtkTextView *text_view)
{
  GdkRectangle area;
  ...
  dasher_gtk_text_view_get_cursor_location (text_view, &area);
...
/**
 * dasher_gtk_text_view_scroll_to_mark:
 * @text_view: a #DasherGtkTextView
 * @mark: a #GtkTextMark
 * @within_margin: margin as a [0.0,0.5) fraction of screen size
 * @use_align: whether to use alignment arguments (if %FALSE, just get the mark onscreen)
 ...
 **/
void
dasher_gtk_text_view_scroll_to_mark (DasherGtkTextView *text_view,
                              GtkTextMark *mark,
                              gdouble      within_margin,
                              gboolean     use_align,
                              gdouble      xalign,
...
{  
  ...
  dasher_gtk_text_view_queue_scroll (text_view, mark,
                              within_margin,
                              use_align,
                              xalign,
                              yalign);
  ...
  if (text_view->layout &&
    ...
    dasher_gtk_text_view_flush_scroll (text_view);
}

/**
 * dasher_gtk_text_view_scroll_mark_onscreen:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_scroll_mark_onscreen (DasherGtkTextView *text_view,
                                    GtkTextMark *mark)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
  g_return_if_fail (GTK_IS_TEXT_MARK (mark));

  dasher_gtk_text_view_scroll_to_mark (text_view, mark, 0.0, FALSE, 0.0, 0.0);
}

static gboolean
clamp_iter_onscreen (DasherGtkTextView *text_view, GtkTextIter *iter)
{
  GdkRectangle visible_rect;
  dasher_gtk_text_view_get_visible_rect (text_view, &visible_rect);
...
/**
 * dasher_gtk_text_view_move_mark_onscreen:
 * @text_view: a #DasherGtkTextView
 * @mark: a #GtkTextMark
 *
 ...
 **/
gboolean
dasher_gtk_text_view_move_mark_onscreen (DasherGtkTextView *text_view,
                                  GtkTextMark *mark)
{
  GtkTextIter iter;
...
/**
 * dasher_gtk_text_view_get_visible_rect:
 * @text_view: a #DasherGtkTextView
 * @visible_rect: rectangle to fill
 *
 * Fills @visible_rect with the currently-visible
 * region of the buffer, in buffer coordinates. Convert to window coordinates
 * with dasher_gtk_text_view_buffer_to_window_coords().
 **/
void
dasher_gtk_text_view_get_visible_rect (DasherGtkTextView  *text_view,
                                GdkRectangle *visible_rect)
{
  GtkWidget *widget;
...
/**
 * dasher_gtk_text_view_set_wrap_mode:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_wrap_mode (DasherGtkTextView *text_view,
...
/**
 * dasher_gtk_text_view_get_wrap_mode:
 * @text_view: a #DasherGtkTextView
 *
 ...
 **/
GtkWrapMode
dasher_gtk_text_view_get_wrap_mode (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), GTK_WRAP_NONE);

  return text_view->wrap_mode;
}

/**
 * dasher_gtk_text_view_set_editable:
 * @text_view: a #DasherGtkTextView
 * @setting: whether it's editable
 *
 * Sets the default editability of the #DasherGtkTextView. You can override
 * this default setting with tags in the buffer, using the "editable"
 * attribute of tags.
 **/
void
dasher_gtk_text_view_set_editable (DasherGtkTextView *text_view,
                            gboolean     setting)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
...
/**
 * dasher_gtk_text_view_get_editable:
 * @text_view: a #DasherGtkTextView
 *
 * Returns the default editability of the #DasherGtkTextView. Tags in the
 * buffer may override this setting for some ranges of text.
 *
 * Return value: whether text is editable by default
 **/
gboolean
dasher_gtk_text_view_get_editable (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
...
/**
 * dasher_gtk_text_view_set_pixels_above_lines:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_pixels_above_lines (DasherGtkTextView *text_view,
...
/**
 * dasher_gtk_text_view_get_pixels_above_lines:
 * @text_view: a #DasherGtkTextView
 * 
 ...
 **/
gint
dasher_gtk_text_view_get_pixels_above_lines (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), 0);

  return text_view->pixels_above_lines;
}

/**
 * dasher_gtk_text_view_set_pixels_below_lines:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_pixels_below_lines (DasherGtkTextView *text_view,
...
/**
 * dasher_gtk_text_view_get_pixels_below_lines:
 * @text_view: a #DasherGtkTextView
 * 
 * Gets the value set by dasher_gtk_text_view_set_pixels_below_lines().
 * 
 * Return value: default number of blank pixels below paragraphs
 **/
gint
dasher_gtk_text_view_get_pixels_below_lines (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), 0);
...
/**
 * dasher_gtk_text_view_set_pixels_inside_wrap:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_pixels_inside_wrap (DasherGtkTextView *text_view,
...
/**
 * dasher_gtk_text_view_get_pixels_inside_wrap:
 * @text_view: a #DasherGtkTextView
 * 
 * Gets the value set by dasher_gtk_text_view_set_pixels_inside_wrap().
 * 
 * Return value: default number of pixels of blank space between wrapped lines
 **/
gint
dasher_gtk_text_view_get_pixels_inside_wrap (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), 0);
...
/**
 * dasher_gtk_text_view_set_justification:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_justification (DasherGtkTextView     *text_view,
...
/**
 * dasher_gtk_text_view_get_justification:
 * @text_view: a #DasherGtkTextView
 * 
 ...
 **/
GtkJustification
dasher_gtk_text_view_get_justification (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), GTK_JUSTIFY_LEFT);

  return text_view->justify;
}

/**
 * dasher_gtk_text_view_set_left_margin:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_left_margin (DasherGtkTextView *text_view,
                               gint         left_margin)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
...
/**
 * dasher_gtk_text_view_get_left_margin:
 * @text_view: a #DasherGtkTextView
 * 
 ...
 **/
gint
dasher_gtk_text_view_get_left_margin (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), 0);
...
/**
 * dasher_gtk_text_view_set_right_margin:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_right_margin (DasherGtkTextView *text_view,
                                gint         right_margin)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
...
/**
 * dasher_gtk_text_view_get_right_margin:
 * @text_view: a #DasherGtkTextView
 * 
 ...
 **/
gint
dasher_gtk_text_view_get_right_margin (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), 0);
...
/**
 * dasher_gtk_text_view_set_indent:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_indent (DasherGtkTextView *text_view,
                          gint         indent)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
...
/**
 * dasher_gtk_text_view_get_indent:
 * @text_view: a #DasherGtkTextView
 * 
 ...
 **/
gint
dasher_gtk_text_view_get_indent (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), 0);
 ...
 **/
void
dasher_gtk_text_view_set_tabs (DasherGtkTextView   *text_view,
                        PangoTabArray *tabs)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
 ...
 **/
PangoTabArray*
dasher_gtk_text_view_get_tabs (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), NULL);
...
/**
 * dasher_gtk_text_view_set_cursor_visible:
 * @text_view: a #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_cursor_visible    (DasherGtkTextView   *text_view,
                                     gboolean       setting)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
      ...
      if (GTK_WIDGET_HAS_FOCUS (text_view))
        {
	      ...
	      dasher_gtk_text_view_check_cursor_blink (text_view);
            }
        }
...
/**
 * dasher_gtk_text_view_get_cursor_visible:
 * @text_view: a #DasherGtkTextView
 *
 ...
 **/
gboolean
dasher_gtk_text_view_get_cursor_visible    (DasherGtkTextView   *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
...
/**
 * dasher_gtk_text_view_place_cursor_onscreen:
 * @text_view: a #DasherGtkTextView
 *
 ...
 **/
gboolean
dasher_gtk_text_view_place_cursor_onscreen (DasherGtkTextView *text_view)
{
  GtkTextIter insert;
...
static void
dasher_gtk_text_view_remove_validate_idles (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_destroy (GtkObject *object)
{
  DasherGtkTextView *text_view;
  GtkTextLayout *layout;
  
  text_view = DASHER_GTK_TEXT_VIEW (object);

  layout = text_view->layout;
  
  dasher_gtk_text_view_remove_validate_idles (text_view);
  dasher_gtk_text_view_set_buffer (text_view, NULL);
  dasher_gtk_text_view_destroy_layout (text_view);

  (* GTK_OBJECT_CLASS (parent_class)->destroy) (object);
}

static void
dasher_gtk_text_view_finalize (GObject *object)
{
  DasherGtkTextView *text_view;
...
static void
dasher_gtk_text_view_set_property (GObject         *object,
			    guint            prop_id,
			    const GValue    *value,
			    GParamSpec      *pspec)
{
  ...
  switch (prop_id)
    ...
    case PROP_PIXELS_ABOVE_LINES:
      dasher_gtk_text_view_set_pixels_above_lines (text_view, g_value_get_int (value));
      break;

    case PROP_PIXELS_BELOW_LINES:
      dasher_gtk_text_view_set_pixels_below_lines (text_view, g_value_get_int (value));
      break;

    case PROP_PIXELS_INSIDE_WRAP:
      dasher_gtk_text_view_set_pixels_inside_wrap (text_view, g_value_get_int (value));
      break;

    case PROP_EDITABLE:
      dasher_gtk_text_view_set_editable (text_view, g_value_get_boolean (value));
      break;

    case PROP_WRAP_MODE:
      dasher_gtk_text_view_set_wrap_mode (text_view, g_value_get_enum (value));
      break;
      
    case PROP_JUSTIFICATION:
      dasher_gtk_text_view_set_justification (text_view, g_value_get_enum (value));
      break;

    case PROP_LEFT_MARGIN:
      dasher_gtk_text_view_set_left_margin (text_view, g_value_get_int (value));
      break;

    case PROP_RIGHT_MARGIN:
      dasher_gtk_text_view_set_right_margin (text_view, g_value_get_int (value));
      break;

    case PROP_INDENT:
      dasher_gtk_text_view_set_indent (text_view, g_value_get_int (value));
      break;

    case PROP_TABS:
      dasher_gtk_text_view_set_tabs (text_view, g_value_get_boxed (value));
      break;

    case PROP_CURSOR_VISIBLE:
      dasher_gtk_text_view_set_cursor_visible (text_view, g_value_get_boolean (value));
      break;

    case PROP_OVERWRITE:
      dasher_gtk_text_view_set_overwrite (text_view, g_value_get_boolean (value));
      break;

    case PROP_BUFFER:
      dasher_gtk_text_view_set_buffer (text_view, GTK_TEXT_BUFFER (g_value_get_object (value)));
      break;

    case PROP_ACCEPTS_TAB:
      dasher_gtk_text_view_set_accepts_tab (text_view, g_value_get_boolean (value));
      break;
...
static void
dasher_gtk_text_view_get_property (GObject         *object,
			    guint            prop_id,
			    GValue          *value,
			    GParamSpec      *pspec)
{
...
static void
dasher_gtk_text_view_size_request (GtkWidget      *widget,
                            GtkRequisition *requisition)
{
  DasherGtkTextView *text_view;
  GSList *tmp_list;
  ...
  text_view = DASHER_GTK_TEXT_VIEW (widget);
  ...
  while (tmp_list != NULL)
    {
      DasherGtkTextViewChild *child = tmp_list->data;
...
static void
dasher_gtk_text_view_compute_child_allocation (DasherGtkTextView      *text_view,
                                        DasherGtkTextViewChild *vc,
                                        GtkAllocation    *allocation)
{
  gint buffer_y;
  GtkTextIter iter;
...
static void
dasher_gtk_text_view_update_child_allocation (DasherGtkTextView      *text_view,
                                       DasherGtkTextViewChild *vc)
{
  GtkAllocation allocation;

  dasher_gtk_text_view_compute_child_allocation (text_view, vc, &allocation);
...
static void
dasher_gtk_text_view_child_allocated (GtkTextLayout *layout,
                               GtkWidget     *child,
                               gint           x,
                               gint           y,
                               gpointer       data)
{
  DasherGtkTextViewChild *vc = NULL;
  DasherGtkTextView *text_view = data;
  ...
  dasher_gtk_text_view_update_child_allocation (text_view, vc);
}

static void
dasher_gtk_text_view_allocate_children (DasherGtkTextView *text_view)
{
  GSList *tmp_list;
...
static void
dasher_gtk_text_view_size_allocate (GtkWidget *widget,
                             GtkAllocation *allocation)
{
  DasherGtkTextView *text_view;
  ...
  dasher_gtk_text_view_update_layout_width (text_view);
  
  /* Note that this will do some layout validation */
  dasher_gtk_text_view_allocate_children (text_view);
   ...
   */
  dasher_gtk_text_view_get_first_para_iter (text_view, &first_para);
   ...
   */
  dasher_gtk_text_view_flush_first_validate (text_view);
...
static void
dasher_gtk_text_view_get_first_para_iter (DasherGtkTextView *text_view,
                                   GtkTextIter *iter)
{
...
static void
dasher_gtk_text_view_validate_onscreen (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_flush_first_validate (DasherGtkTextView *text_view)
{
  if (text_view->first_validate_idle == 0)
    return;
  ...
  if (text_view->first_validate_idle != 0)
  ...
  else
    {
       ...
       * necessary.
       */
      if (!dasher_gtk_text_view_flush_scroll (text_view) ||
          !text_view->onscreen_validated)
	dasher_gtk_text_view_validate_onscreen (text_view);
...
static void
dasher_gtk_text_view_invalidate (DasherGtkTextView *text_view)
{  
  ...
  if (!text_view->incremental_validate_idle)
    {
      text_view->incremental_validate_idle = g_idle_add_full (DASHER_GTK_TEXT_VIEW_PRIORITY_VALIDATE, incremental_validate_callback, text_view, NULL);
                     ...
                     gpointer       data)
{
  ...
  text_view = DASHER_GTK_TEXT_VIEW (data);
      ...
      if (gdk_rectangle_intersect (&redraw_rect, &visible_rect, &redraw_rect))
        {
          ...
          dasher_gtk_text_view_update_im_spot_location (text_view);
        }
    }
      ...
      while (tmp_list != NULL)
        {
          ...
          if (child->anchor)
            dasher_gtk_text_view_update_child_allocation (text_view, child);
...
static void
dasher_gtk_text_view_realize (GtkWidget *widget)
{
  DasherGtkTextView *text_view;
...
static void
dasher_gtk_text_view_unrealize (GtkWidget *widget)
{
  DasherGtkTextView *text_view;
...
static void 
dasher_gtk_text_view_set_background (DasherGtkTextView *text_view)
{
  GtkWidget *widget = GTK_WIDGET (text_view);
...
static void
dasher_gtk_text_view_style_set (GtkWidget *widget,
                         GtkStyle  *previous_style)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);

  if (GTK_WIDGET_REALIZED (widget))
    {
      dasher_gtk_text_view_set_background (text_view);
    }

  if (text_view->layout && previous_style)
    {
      dasher_gtk_text_view_set_attributes_from_style (text_view,
...
static void
dasher_gtk_text_view_direction_changed (GtkWidget        *widget,
                                 GtkTextDirection  previous_direction)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);
...
static void
dasher_gtk_text_view_state_changed (GtkWidget      *widget,
		 	     GtkStateType    previous_state)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);
  ...
  if (!GTK_WIDGET_IS_SENSITIVE (widget))
    {
      /* Clear any selection */
      dasher_gtk_text_view_unselect (text_view);
    }
...
static void
dasher_gtk_text_view_obscure_mouse_cursor (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_unobscure_mouse_cursor (DasherGtkTextView *text_view)
{
  if (text_view->mouse_cursor_obscured)
    {
      GdkCursor *cursor;
...
static void
dasher_gtk_text_view_grab_notify (GtkWidget *widget,
		 	   gboolean   was_grabbed)
{
  if (!was_grabbed)
    dasher_gtk_text_view_unobscure_mouse_cursor (DASHER_GTK_TEXT_VIEW (widget));
}
...
static gint
dasher_gtk_text_view_event (GtkWidget *widget, GdkEvent *event)
{
  DasherGtkTextView *text_view;
  gint x = 0, y = 0;
...
static gint
dasher_gtk_text_view_key_press_event (GtkWidget *widget, GdkEventKey *event)
{
  gboolean retval = FALSE;
  ...
  /* use overall editability not can_insert, more predictable for users */
            ...
            event->keyval == GDK_KP_Enter))
    {
       ...
       * editable
       */
      dasher_gtk_text_view_commit_text (text_view, "\n");
  ...
  /* Pass through Tab as literal tab, unless Control is held down */
	...
	dasher_gtk_text_view_move_focus (text_view,
  ...
  if (obscure)
    dasher_gtk_text_view_obscure_mouse_cursor (text_view);
  
  dasher_gtk_text_view_pend_cursor_blink (text_view);

  return retval;
}

static gint
dasher_gtk_text_view_key_release_event (GtkWidget *widget, GdkEventKey *event)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);
  GtkTextMark *insert;
  GtkTextIter iter;
...
static gint
dasher_gtk_text_view_button_press_event (GtkWidget *widget, GdkEventButton *event)
{
  DasherGtkTextView *text_view;
  ...
  if (event->button == 3 && (event->state & GDK_CONTROL_MASK) != 0)
    _gtk_text_buffer_spew (DASHER_GTK_TEXT_VIEW (widget)->buffer);
  else if (event->button == 3)
    gtk_text_layout_spew (DASHER_GTK_TEXT_VIEW (widget)->layout);
#endif

  if (event->type == GDK_BUTTON_PRESS)
    {
      dasher_gtk_text_view_reset_im_context (text_view);
      ...
      if (event->button == 1)
        {
          ...
          if (gtk_text_buffer_get_selection_bounds (get_buffer (text_view),
            ...
            {
              dasher_gtk_text_view_start_selection_drag (text_view, &iter, event);
            }
        ...
        {
	  dasher_gtk_text_view_do_popup (text_view, event);
	  return TRUE;
        }
    }
	   ...
	   event->button == 1) 
    {
      ...
      dasher_gtk_text_view_end_selection_drag (text_view, event);      
...
static gint
dasher_gtk_text_view_button_release_event (GtkWidget *widget, GdkEventButton *event)
{
  DasherGtkTextView *text_view;
  ...
  if (event->button == 1)
    {
      ...
      if (dasher_gtk_text_view_end_selection_drag (DASHER_GTK_TEXT_VIEW (widget), event))
        return TRUE;
...
keymap_direction_changed (GdkKeymap   *keymap,
			  DasherGtkTextView *text_view)
{
  dasher_gtk_text_view_check_keymap_direction (text_view);
}

static gint
dasher_gtk_text_view_focus_in_event (GtkWidget *widget, GdkEventFocus *event)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);
...
//      gtk_text_layout_set_cursor_visible (text_view->layout, TRUE);
  ...
  text_view->need_im_reset = TRUE;
  gtk_im_context_focus_in (DASHER_GTK_TEXT_VIEW (widget)->im_context);

  return FALSE;
}

static gint
dasher_gtk_text_view_focus_out_event (GtkWidget *widget, GdkEventFocus *event)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);
...
//      dasher_gtk_text_view_check_cursor_blink (text_view);
  ...
  text_view->need_im_reset = TRUE;
  gtk_im_context_focus_out (DASHER_GTK_TEXT_VIEW (widget)->im_context);

  return FALSE;
}

static gint
dasher_gtk_text_view_motion_event (GtkWidget *widget, GdkEventMotion *event)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);

  dasher_gtk_text_view_unobscure_mouse_cursor (text_view);
      ...
      text_view->drag_start_x >= 0)
    {
      ...
      if (gtk_drag_check_threshold (widget,
				    ...
				    x, y))
        {
          ...
          dasher_gtk_text_view_window_to_buffer_coords (text_view,
          ...
          dasher_gtk_text_view_start_selection_dnd (text_view, &iter, event);
          return TRUE;
        }
    }
...
static void
dasher_gtk_text_view_paint (GtkWidget      *widget,
                     GdkRectangle   *area,
...
static gint
dasher_gtk_text_view_expose_event (GtkWidget *widget, GdkEventExpose *event)
{
  GSList *tmp_list;
  
  if (event->window == dasher_gtk_text_view_get_window (DASHER_GTK_TEXT_VIEW (widget),
                                                 DASHER_GTK_TEXT_WINDOW_TEXT))
    {
      DV(g_print (">Exposed ("G_STRLOC")\n"));
      dasher_gtk_text_view_paint (widget, &event->area, event);
    }

  if (event->window == widget->window)
    dasher_gtk_text_view_draw_focus (widget);

  /* Propagate exposes to all unanchored children. 
   * Anchored children are handled in dasher_gtk_text_view_paint(). 
   */
  tmp_list = DASHER_GTK_TEXT_VIEW (widget)->children;
  while (tmp_list != NULL)
    {
      DasherGtkTextViewChild *vc = tmp_list->data;
...
static void
dasher_gtk_text_view_draw_focus (GtkWidget *widget)
{
  gboolean interior_focus;
...
static gboolean
dasher_gtk_text_view_focus (GtkWidget        *widget,
                     GtkDirectionType  direction)
{
  DasherGtkTextView *text_view;
...
static void
dasher_gtk_text_view_add (GtkContainer *container,
                   GtkWidget    *child)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (container));
  g_return_if_fail (GTK_IS_WIDGET (child));

  /* This is pretty random. */
  dasher_gtk_text_view_add_child_in_window (DASHER_GTK_TEXT_VIEW (container),
                                     child,
...
static void
dasher_gtk_text_view_remove (GtkContainer *container,
                      GtkWidget    *child)
{
  GSList *iter;
  DasherGtkTextView *text_view;
  ...
  text_view = DASHER_GTK_TEXT_VIEW (container);
...
static void
dasher_gtk_text_view_forall (GtkContainer *container,
                      gboolean      include_internals,
                      GtkCallback   callback,
                      gpointer      callback_data)
{
  ...
  while (iter != NULL)
    {
      DasherGtkTextViewChild *vc = iter->data;
...
static gboolean
cursor_blinks (DasherGtkTextView *text_view)
{
...
static gint
get_cursor_time (DasherGtkTextView *text_view)
{
  GtkSettings *settings = gtk_widget_get_settings (GTK_WIDGET (text_view));
  gint time;
...
blink_cb (gpointer data)
{
  ...
  if (!GTK_WIDGET_HAS_FOCUS (text_view))
    {
      g_warning ("DasherGtkTextView - did not receive focus-out-event. If you\n"
...
static void
dasher_gtk_text_view_stop_cursor_blink (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_check_cursor_blink (DasherGtkTextView *text_view)
{
  if (text_view->layout != NULL &&
    ...
    {
      dasher_gtk_text_view_stop_cursor_blink (text_view);
    }
}

static void
dasher_gtk_text_view_pend_cursor_blink(DasherGtkTextView *text_view)
{
  if (text_view->layout != NULL &&
      text_view->cursor_visible &&
      GTK_WIDGET_HAS_FOCUS (text_view) &&
...
static gboolean
dasher_gtk_text_view_move_iter_by_lines (DasherGtkTextView *text_view,
...
static void
move_cursor (DasherGtkTextView       *text_view,
...
static void
dasher_gtk_text_view_move_cursor_internal (DasherGtkTextView     *text_view,
                                    GtkMovementStep  step,
                                    gint             count,
                                    gboolean         extend_selection)
{
  ...
  if (!text_view->cursor_visible) 
	...
	default:
      ...
      dasher_gtk_text_view_move_viewport (text_view, scroll_step, count);
  ...
  if (step == GTK_MOVEMENT_PAGES)
    {
      dasher_gtk_text_view_scroll_pages (text_view, count, extend_selection);
      dasher_gtk_text_view_pend_cursor_blink (text_view);
      return;
    }
  else if (step == GTK_MOVEMENT_HORIZONTAL_PAGES)
    {
      dasher_gtk_text_view_scroll_hpages (text_view, count, extend_selection);
      dasher_gtk_text_view_pend_cursor_blink (text_view);
      return;
    }
  ...
  if (step == GTK_MOVEMENT_DISPLAY_LINES)
    dasher_gtk_text_view_get_virtual_cursor_pos (text_view, &cursor_x_pos, NULL);
  ...
  switch (step)
    ...
    case GTK_MOVEMENT_DISPLAY_LINES:
      if (count < 0)
      {
        if (dasher_gtk_text_view_move_iter_by_lines (text_view, &newplace, count))
    ...
    case GTK_MOVEMENT_DISPLAY_LINE_ENDS:
      if (count > 1)
        dasher_gtk_text_view_move_iter_by_lines (text_view, &newplace, --count);
      else if (count < -1)
        dasher_gtk_text_view_move_iter_by_lines (text_view, &newplace, ++count);
  ...
  if (!gtk_text_iter_equal (&insert, &newplace))
    {
      ...
      dasher_gtk_text_view_scroll_mark_onscreen (text_view,
                                          gtk_text_buffer_get_mark (get_buffer (text_view),
                                                                    "insert"));

      if (step == GTK_MOVEMENT_DISPLAY_LINES)
        {
          dasher_gtk_text_view_set_virtual_cursor_pos (text_view, cursor_x_pos, -1);
        }
    }
...
static void
dasher_gtk_text_view_move_cursor (DasherGtkTextView     *text_view,
                           GtkMovementStep  step,
                           gint             count,
                           gboolean         extend_selection)
{
  dasher_gtk_text_view_move_cursor_internal (text_view, step, count, extend_selection);
}

static void
dasher_gtk_text_view_page_horizontally (DasherGtkTextView     *text_view,
                                 gint             count,
                                 gboolean         extend_selection)
{
  dasher_gtk_text_view_move_cursor_internal (text_view, GTK_MOVEMENT_HORIZONTAL_PAGES,
                                      count, extend_selection);
}


static void
dasher_gtk_text_view_move_viewport (DasherGtkTextView     *text_view,
                             GtkScrollStep    step,
                             gint             count)
{
...
static void
dasher_gtk_text_view_set_anchor (DasherGtkTextView *text_view)
{
  GtkTextIter insert;
...
static void
dasher_gtk_text_view_scroll_pages (DasherGtkTextView *text_view,
                            gint         count,
                            gboolean     extend_selection)
{
  gdouble newval;
...
/* Validate the region that will be brought into view by the cursor motion
  ...
  if (count < 0)
    {
      dasher_gtk_text_view_get_first_para_iter (text_view, &anchor);
      y0 = adj->page_size;
  ...
  if (count < 0 && adj->value <= (adj->lower + 1e-12))
    ...
    {
      dasher_gtk_text_view_get_virtual_cursor_pos (text_view, &cursor_x_pos, &cursor_y_pos);
      ...
      dasher_gtk_text_view_set_virtual_cursor_pos (text_view, cursor_x_pos, cursor_y_pos);
    }
...
static void
dasher_gtk_text_view_scroll_hpages (DasherGtkTextView *text_view,
                             gint         count,
                             gboolean     extend_selection)
{
  gdouble newval;
...
static void
dasher_gtk_text_view_insert_at_cursor (DasherGtkTextView *text_view,
                                const gchar *str)
{
...
static void
dasher_gtk_text_view_delete_from_cursor (DasherGtkTextView   *text_view,
                                  GtkDeleteType  type,
                                  gint           count)
{
  GtkTextIter insert;
...
static void
dasher_gtk_text_view_backspace (DasherGtkTextView *text_view)
{
  GtkTextIter insert;
...
static void
dasher_gtk_text_view_cut_clipboard (DasherGtkTextView *text_view)
{
  GtkClipboard *clipboard = gtk_widget_get_clipboard (GTK_WIDGET (text_view),
...
static void
dasher_gtk_text_view_copy_clipboard (DasherGtkTextView *text_view)
{
  GtkClipboard *clipboard = gtk_widget_get_clipboard (GTK_WIDGET (text_view),
						      GDK_SELECTION_CLIPBOARD);
...
static void
dasher_gtk_text_view_paste_clipboard (DasherGtkTextView *text_view)
{
  GtkClipboard *clipboard = gtk_widget_get_clipboard (GTK_WIDGET (text_view),
						      GDK_SELECTION_CLIPBOARD);
...
static void
dasher_gtk_text_view_toggle_overwrite (DasherGtkTextView *text_view)
{
...
/**
 * dasher_gtk_text_view_get_overwrite:
 * @text_view: a #DasherGtkTextView
 *
 * Returns whether the #DasherGtkTextView is in overwrite mode or not.
 *
 ...
 **/
gboolean
dasher_gtk_text_view_get_overwrite (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
...
/**
 * dasher_gtk_text_view_set_overwrite:
 * @text_view: a #DasherGtkTextView
 * @overwrite: %TRUE to turn on overwrite mode, %FALSE to turn it off
 *
 * Changes the #DasherGtkTextView overwrite mode.
 *
 * Since: 2.4
 **/
void
dasher_gtk_text_view_set_overwrite (DasherGtkTextView *text_view,
			     gboolean     overwrite)
{
  g_return_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view));
...
/**
 * dasher_gtk_text_view_set_accepts_tab:
 * @text_view: A #DasherGtkTextView
 ...
 **/
void
dasher_gtk_text_view_set_accepts_tab (DasherGtkTextView *text_view,
...
/**
 * dasher_gtk_text_view_get_accepts_tab:
 * @text_view: A #DasherGtkTextView
 * 
 ...
 **/
gboolean
dasher_gtk_text_view_get_accepts_tab (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
...
static void
dasher_gtk_text_view_move_focus (DasherGtkTextView     *text_view,
                          GtkDirectionType direction_type)
{
...
static void
dasher_gtk_text_view_unselect (DasherGtkTextView *text_view)
{
  GtkTextIter insert;
...
static void
move_mark_to_pointer_and_scroll (DasherGtkTextView *text_view,
                                 const gchar *mark_name)
{
...

  {
    ...
    DV(g_print (G_STRLOC": scrolling onscreen\n"));
    dasher_gtk_text_view_scroll_mark_onscreen (text_view, mark);
  }
...
drag_scan_timeout (gpointer data)
{
  ...
  DV(g_print (G_STRLOC": scrolling onscreen\n"));
  dasher_gtk_text_view_scroll_to_mark (text_view,
                                text_view->dnd_mark,
 ...
 */
static gboolean 
extend_selection (DasherGtkTextView *text_view, 
		  ...
		  GtkTextIter *end)
{
  ...
  *end = *start;
  ...
  if (granularity == SELECT_WORDS) 
    ...
    {
      if (dasher_gtk_text_view_starts_display_line (text_view, start))
	{
	   ...
	   */
	  dasher_gtk_text_view_backward_display_line_start (text_view, start);
	}
      else
	{
	  ...
	  if (!dasher_gtk_text_view_starts_display_line (text_view, end))
	    dasher_gtk_text_view_forward_display_line_end (text_view, end);
	}
    }
...
static gint
selection_motion_event_handler (DasherGtkTextView *text_view, GdkEventMotion *event, gpointer data)
{
...
static void
dasher_gtk_text_view_start_selection_drag (DasherGtkTextView       *text_view,
                                    const GtkTextIter *iter,
...
static gboolean
dasher_gtk_text_view_end_selection_drag (DasherGtkTextView *text_view, GdkEventButton *event)
{
...
static void
dasher_gtk_text_view_set_attributes_from_style (DasherGtkTextView        *text_view,
                                         GtkTextAttributes  *values,
                                         GtkStyle           *style)
{
...
static void
dasher_gtk_text_view_check_keymap_direction (DasherGtkTextView *text_view)
{
  if (text_view->layout)
    {
      GtkSettings *settings = gtk_widget_get_settings (GTK_WIDGET (text_view));
...
static void
dasher_gtk_text_view_ensure_layout (DasherGtkTextView *text_view)
{
  GtkWidget *widget;
  ...
  if (text_view->layout == NULL)
    {
      ...
      g_signal_connect (text_view->layout,
			"allocate_child",
			G_CALLBACK (dasher_gtk_text_view_child_allocated),
			text_view);
...
/**
 * dasher_gtk_text_view_get_default_attributes:
 * @text_view: a #DasherGtkTextView
 * 
 ...
 **/
GtkTextAttributes*
dasher_gtk_text_view_get_default_attributes (DasherGtkTextView *text_view)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), NULL);
...
static void
dasher_gtk_text_view_destroy_layout (DasherGtkTextView *text_view)
{
  if (text_view->layout)
    {
      GSList *tmp_list;
      ...
      dasher_gtk_text_view_stop_cursor_blink (text_view);
      dasher_gtk_text_view_end_selection_drag (text_view, NULL);
...
static void
dasher_gtk_text_view_reset_im_context (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_start_selection_dnd (DasherGtkTextView       *text_view,
                                   const GtkTextIter *iter,
                                   GdkEventMotion    *event)
{
  GdkDragContext *context;
...
static void
dasher_gtk_text_view_drag_begin (GtkWidget        *widget,
                          GdkDragContext   *context)
{
  /* do nothing */
}
...
static void
dasher_gtk_text_view_drag_end (GtkWidget        *widget,
                        GdkDragContext   *context)
{
  DasherGtkTextView *text_view;
...
static void
dasher_gtk_text_view_drag_data_get (GtkWidget        *widget,
                             GdkDragContext   *context,
                             GtkSelectionData *selection_data,
                             guint             info,
                             guint             time)
{
  ...
  if (selection_data->target == gdk_atom_intern ("GTK_TEXT_BUFFER_CONTENTS", FALSE))
    {
      GtkTextBuffer *buffer = dasher_gtk_text_view_get_buffer (text_view);
...
static void
dasher_gtk_text_view_drag_data_delete (GtkWidget        *widget,
                                GdkDragContext   *context)
{
  DasherGtkTextView *text_view;
  ...
  gtk_text_buffer_delete_selection (DASHER_GTK_TEXT_VIEW (widget)->buffer,
                                    TRUE, DASHER_GTK_TEXT_VIEW (widget)->editable);
}

static void
dasher_gtk_text_view_drag_leave (GtkWidget        *widget,
                          GdkDragContext   *context,
                          guint             time)
{
  DasherGtkTextView *text_view;
...
static gboolean
dasher_gtk_text_view_drag_motion (GtkWidget        *widget,
                           GdkDragContext   *context,
                           gint              x,
                           gint              y,
                           guint             time)
...
static gboolean
dasher_gtk_text_view_drag_drop (GtkWidget        *widget,
                         GdkDragContext   *context,
                         gint              x,
                         gint              y,
                         guint             time)
...
static void
insert_text_data (DasherGtkTextView      *text_view,
                  GtkTextIter      *drop_point,
                  GtkSelectionData *selection_data)
{
  gchar *str;
...
static void
dasher_gtk_text_view_drag_data_received (GtkWidget        *widget,
                                  GdkDragContext   *context,
                                  gint              x,
                                  gint              y,
                                  GtkSelectionData *selection_data,
...
get_hadjustment (DasherGtkTextView *text_view)
{
  if (text_view->hadjustment == NULL)
    dasher_gtk_text_view_set_scroll_adjustments (text_view,
...
static GtkAdjustment*
get_vadjustment (DasherGtkTextView *text_view)
{
...
static void
dasher_gtk_text_view_set_scroll_adjustments (DasherGtkTextView   *text_view,
                                      GtkAdjustment *hadj,
                                      GtkAdjustment *vadj)
{
  ...
  if (text_view->hadjustment && (text_view->hadjustment != hadj))
    {
      g_signal_handlers_disconnect_by_func (text_view->hadjustment,
					    dasher_gtk_text_view_value_changed,
					    text_view);
      g_object_unref (text_view->hadjustment);
    }
  ...
  if (text_view->hadjustment != hadj)
    {
      ...
      g_signal_connect (text_view->hadjustment, "value_changed",
                        G_CALLBACK (dasher_gtk_text_view_value_changed),
			text_view);
      need_adjust = TRUE;
    }
  ...
  if (need_adjust)
    dasher_gtk_text_view_value_changed (NULL, text_view);
}
...
static void
dasher_gtk_text_view_value_changed (GtkAdjustment *adj,
                             DasherGtkTextView   *text_view)
{
  GtkTextIter iter;
  gint line_top;
...
static void
dasher_gtk_text_view_commit_handler (GtkIMContext  *context,
                              const gchar   *str,
                              DasherGtkTextView   *text_view)
{
  dasher_gtk_text_view_commit_text (text_view, str);
}

static void
dasher_gtk_text_view_commit_text (DasherGtkTextView   *text_view,
                           const gchar   *str)
{
  ...
  if (!strcmp (str, "\n"))
      ...
      if (!had_selection && text_view->overwrite_mode)
	{
	  ...
	  if (!gtk_text_iter_ends_line (&insert))
	    dasher_gtk_text_view_delete_from_cursor (text_view, GTK_DELETE_CHARS, 1);
	}
      gtk_text_buffer_insert_interactive_at_cursor (get_buffer (text_view), str, -1,
                                                    text_view->editable);
    }
...
static void
dasher_gtk_text_view_preedit_changed_handler (GtkIMContext *context,
				       DasherGtkTextView  *text_view)
{
  gchar *str;
  PangoAttrList *attrs;
...
static gboolean
dasher_gtk_text_view_retrieve_surrounding_handler (GtkIMContext  *context,
					    DasherGtkTextView   *text_view)
{
  GtkTextIter start;
  GtkTextIter end;
...
static gboolean
dasher_gtk_text_view_delete_surrounding_handler (GtkIMContext  *context,
					  gint           offset,
					  gint           n_chars,
					  DasherGtkTextView   *text_view)
{
...
static void
dasher_gtk_text_view_mark_set_handler (GtkTextBuffer     *buffer,
                                const GtkTextIter *location,
                                GtkTextMark       *mark,
                                gpointer           data)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (data);
...
static void
dasher_gtk_text_view_get_cursor_location  (DasherGtkTextView   *text_view,
				    GdkRectangle  *pos)
{
  GtkTextIter insert;
...
static void
dasher_gtk_text_view_get_virtual_cursor_pos (DasherGtkTextView *text_view,
                                      gint        *x,
                                      gint        *y)
{
  GdkRectangle pos;
  ...
  if ((x && text_view->virtual_cursor_x == -1) ||
    ...
    dasher_gtk_text_view_get_cursor_location (text_view, &pos);
...
static void
dasher_gtk_text_view_set_virtual_cursor_pos (DasherGtkTextView *text_view,
                                      gint         x,
                                      gint         y)
{
  GdkRectangle pos;
...
static void
append_action_signal (DasherGtkTextView  *text_view,
		      GtkWidget    *menu,
...
static void
dasher_gtk_text_view_select_all (GtkWidget *widget,
			  gboolean select)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (widget);
  GtkTextBuffer *buffer;
...
select_all_cb (GtkWidget   *menuitem,
	       DasherGtkTextView *text_view)
{
  dasher_gtk_text_view_select_all (GTK_WIDGET (text_view), TRUE);
}

static void
delete_cb (DasherGtkTextView *text_view)
{
  gtk_text_buffer_delete_selection (get_buffer (text_view), TRUE,
				    text_view->editable);
}
...
popup_menu_detach (GtkWidget *attach_widget,
		   GtkMenu   *menu)
{
  DASHER_GTK_TEXT_VIEW (attach_widget)->popup_menu = NULL;
}
                     ...
                     gpointer	user_data)
{
  ...
  text_view = DASHER_GTK_TEXT_VIEW (user_data);
  widget = GTK_WIDGET (text_view);
  ...
  dasher_gtk_text_view_get_iter_location (text_view,
                                   &iter,
                                   &cursor_rect);

  dasher_gtk_text_view_get_visible_rect (text_view, &onscreen_rect);
  ...
  if (cursor_rect.x >= onscreen_rect.x &&
    ...
    {    
      dasher_gtk_text_view_buffer_to_window_coords (text_view,
                                             DASHER_GTK_TEXT_WINDOW_WIDGET,
                     ...
                     gpointer    data)
{
  ...
  dasher_gtk_text_view_commit_text (text_view, text);
}
			...
			gpointer          user_data)
{
  ...
  DasherGtkTextView *text_view = info->text_view;
...
static void
dasher_gtk_text_view_do_popup (DasherGtkTextView    *text_view,
                        GdkEventButton *event)
{
...
static gboolean
dasher_gtk_text_view_popup_menu (GtkWidget *widget)
{
  dasher_gtk_text_view_do_popup (DASHER_GTK_TEXT_VIEW (widget), NULL);  
  return TRUE;
}
...
static DasherGtkTextWindow*
text_window_new (DasherGtkTextWindowType  type,
                 GtkWidget         *widget,
                 gint               width_request,
                 gint               height_request)
{
  DasherGtkTextWindow *win;

  win = g_new (DasherGtkTextWindow, 1);
...
static void
text_window_free (DasherGtkTextWindow *win)
{
  if (win->window)
...
static void
text_window_realize (DasherGtkTextWindow *win,
                     GdkWindow     *parent)
{
  GdkWindowAttr attributes;
  gint attributes_mask;
  ...
  if (win->type == DASHER_GTK_TEXT_WINDOW_TEXT)
    {
      /* I-beam cursor */
      ...
      gtk_im_context_set_client_window (DASHER_GTK_TEXT_VIEW (win->widget)->im_context,
                                        win->window);
...
static void
text_window_unrealize (DasherGtkTextWindow *win)
{
  if (win->type == DASHER_GTK_TEXT_WINDOW_TEXT)
    {
      gtk_im_context_set_client_window (DASHER_GTK_TEXT_VIEW (win->widget)->im_context,
...
static void
text_window_size_allocate (DasherGtkTextWindow *win,
                           GdkRectangle  *rect)
{
  win->allocation = *rect;
...
static void
text_window_scroll        (DasherGtkTextWindow *win,
                           gint           dx,
                           gint           dy)
{
  if (dx != 0 || dy != 0)
...
static void
text_window_invalidate_rect (DasherGtkTextWindow *win,
                             GdkRectangle  *rect)
{
  GdkRectangle window_rect;

  dasher_gtk_text_view_buffer_to_window_coords (DASHER_GTK_TEXT_VIEW (win->widget),
                                         win->type,
                                         rect->x,
                                         rect->y,
                                         &window_rect.x,
  ...
  switch (win->type)
    {
    case DASHER_GTK_TEXT_WINDOW_TEXT:
      break;

    case DASHER_GTK_TEXT_WINDOW_LEFT:
    case DASHER_GTK_TEXT_WINDOW_RIGHT:
      window_rect.x = 0;
      window_rect.width = win->allocation.width;
      break;

    case DASHER_GTK_TEXT_WINDOW_TOP:
    case DASHER_GTK_TEXT_WINDOW_BOTTOM:
      window_rect.y = 0;
...
static void
text_window_invalidate_cursors (DasherGtkTextWindow *win)
{
  DasherGtkTextView *text_view = DASHER_GTK_TEXT_VIEW (win->widget);
  GtkTextIter  iter;
  GdkRectangle strong;
  GdkRectangle weak;
  gboolean     draw_arrow;
...
static gint
text_window_get_width (DasherGtkTextWindow *win)
{
  return win->allocation.width;
}

static gint
text_window_get_height (DasherGtkTextWindow *win)
{
...
/**
 * dasher_gtk_text_view_get_window:
 * @text_view: a #DasherGtkTextView
 * @win: window to get
 *
 ...
 **/
GdkWindow*
dasher_gtk_text_view_get_window (DasherGtkTextView *text_view,
                          DasherGtkTextWindowType win)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), NULL);

  switch (win)
    {
    case DASHER_GTK_TEXT_WINDOW_WIDGET:
    ...
    case DASHER_GTK_TEXT_WINDOW_PRIVATE:
      g_warning ("%s: You can't get DASHER_GTK_TEXT_WINDOW_PRIVATE, it has \"PRIVATE\" in the name because it is private.", G_GNUC_FUNCTION);
      return NULL;
      break;
    }

  g_warning ("%s: Unknown DasherGtkTextWindowType", G_GNUC_FUNCTION);
  return NULL;
}

/**
 * dasher_gtk_text_view_get_window_type:
 * @text_view: a #DasherGtkTextView
...
dasher_gtk_text_view_get_window_type (DasherGtkTextView *text_view,
                               GdkWindow   *window)
{
  DasherGtkTextWindow *win;
  ...
  if (window == GTK_WIDGET (text_view)->window)
    return DASHER_GTK_TEXT_WINDOW_WIDGET;
  ...
  if (win)
    ...
    {
      return DASHER_GTK_TEXT_WINDOW_PRIVATE;
    }
}

static void
buffer_to_widget (DasherGtkTextView      *text_view,
                  gint              buffer_x,
                  gint              buffer_y,
                  gint             *window_x,
                  gint             *window_y)
...
static void
widget_to_text_window (DasherGtkTextWindow *win,
                       gint           widget_x,
                       gint           widget_y,
                       gint          *window_x,
                       gint          *window_y)
...
static void
buffer_to_text_window (DasherGtkTextView   *text_view,
                       DasherGtkTextWindow *win,
                       gint           buffer_x,
                       gint           buffer_y,
                       gint          *window_x,
  ...
  if (win == NULL)
    {
      g_warning ("Attempt to convert text buffer coordinates to coordinates "
                 "for a nonexistent or private child window of DasherGtkTextView");
      return;
    }
...
/**
 * dasher_gtk_text_view_buffer_to_window_coords:
 * @text_view: a #DasherGtkTextView
 * @win: a #DasherGtkTextWindowType except #DASHER_GTK_TEXT_WINDOW_PRIVATE
 ...
 * dasher_gtk_text_view_set_border_window_size()).
 **/
void
dasher_gtk_text_view_buffer_to_window_coords (DasherGtkTextView      *text_view,
                                       DasherGtkTextWindowType win,
                                       gint              buffer_x,
                                       gint              buffer_y,
                                       gint             *window_x,
                                       gint             *window_y)
{
  ...
  switch (win)
    ...
    default:
      g_warning ("%s: Unknown DasherGtkTextWindowType", G_STRLOC);
      break;
    }
}

static void
widget_to_buffer (DasherGtkTextView *text_view,
                  gint         widget_x,
                  gint         widget_y,
                  gint        *buffer_x,
                  gint        *buffer_y)
...
static void
text_window_to_widget (DasherGtkTextWindow *win,
                       gint           window_x,
                       gint           window_y,
                       gint          *widget_x,
                       gint          *widget_y)
...
static void
text_window_to_buffer (DasherGtkTextView   *text_view,
                       DasherGtkTextWindow *win,
                       gint           window_x,
                       gint           window_y,
                       gint          *buffer_x,
                       gint          *buffer_y)
{
  if (win == NULL)
    {
      g_warning ("Attempt to convert DasherGtkTextView buffer coordinates into "
 ...
 **/
void
dasher_gtk_text_view_window_to_buffer_coords (DasherGtkTextView      *text_view,
                                       DasherGtkTextWindowType win,
                                       gint              window_x,
                                       gint              window_y,
                                       gint             *buffer_x,
...
static void
set_window_width (DasherGtkTextView      *text_view,
                  gint              width,
                  DasherGtkTextWindowType type,
                  DasherGtkTextWindow   **winp)
{
  if (width == 0)
    {
      if (*winp)
...
static void
set_window_height (DasherGtkTextView      *text_view,
                   gint              height,
                   DasherGtkTextWindowType type,
                   DasherGtkTextWindow   **winp)
{
 ...
 *
 * Sets the width of %DASHER_GTK_TEXT_WINDOW_LEFT or %GTK_TEXT_WINDOW_RIGHT,
 * or the height of %DASHER_GTK_TEXT_WINDOW_TOP or %GTK_TEXT_WINDOW_BOTTOM.
 * Automatically destroys the corresponding window if the size is set
 * to 0, and creates the window if the size is set to non-zero.  This
 * function can only be used for the "border windows," it doesn't work
 * with #DASHER_GTK_TEXT_WINDOW_WIDGET, #GTK_TEXT_WINDOW_TEXT, or
 * #DASHER_GTK_TEXT_WINDOW_PRIVATE.
 **/
void
dasher_gtk_text_view_set_border_window_size (DasherGtkTextView      *text_view,
                                      DasherGtkTextWindowType type,
                                      gint              size)

{
  ...
  switch (type)
    {
    case DASHER_GTK_TEXT_WINDOW_LEFT:
      set_window_width (text_view, size, DASHER_GTK_TEXT_WINDOW_LEFT,
                        &text_view->left_window);
      break;

    case DASHER_GTK_TEXT_WINDOW_RIGHT:
      set_window_width (text_view, size, DASHER_GTK_TEXT_WINDOW_RIGHT,
                        &text_view->right_window);
      break;

    case DASHER_GTK_TEXT_WINDOW_TOP:
      set_window_height (text_view, size, DASHER_GTK_TEXT_WINDOW_TOP,
                         &text_view->top_window);
      break;

    case DASHER_GTK_TEXT_WINDOW_BOTTOM:
      set_window_height (text_view, size, DASHER_GTK_TEXT_WINDOW_BOTTOM,
                         &text_view->bottom_window);
      break;

    default:
      g_warning ("Can only set size of left/right/top/bottom border windows with dasher_gtk_text_view_set_border_window_size()");
      break;
    }
}

/**
 * dasher_gtk_text_view_get_border_window_size:
 * @text_view: a #DasherGtkTextView
 ...
 **/
gint
dasher_gtk_text_view_get_border_window_size (DasherGtkTextView       *text_view,
				      DasherGtkTextWindowType  type)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), 0);
  ...
  switch (type)
    ...
    default:
      g_warning ("Can only get size of left/right/top/bottom border windows with dasher_gtk_text_view_get_border_window_size()");
      break;
    }
                              ...
                              GtkTextLayout      *layout)
{
  ...
  vc = g_new (DasherGtkTextViewChild, 1);

  vc->type = DASHER_GTK_TEXT_WINDOW_PRIVATE;
  vc->widget = child;
  vc->anchor = anchor;
...
static void
text_view_child_free (DasherGtkTextViewChild *child)
{
...
static void
text_view_child_set_parent_window (DasherGtkTextView      *text_view,
				   DasherGtkTextViewChild *vc)
{
  if (vc->anchor)
    ...
    {
      GdkWindow *window;
      window = dasher_gtk_text_view_get_window (text_view,
                                         vc->type);
...
static void
add_child (DasherGtkTextView      *text_view,
           DasherGtkTextViewChild *vc)
{
...
/**
 * dasher_gtk_text_view_add_child_at_anchor:
 * @text_view: a #DasherGtkTextView
 * @child: a #GtkWidget
 ...
 **/
void
dasher_gtk_text_view_add_child_at_anchor (DasherGtkTextView          *text_view,
                                   GtkWidget            *child,
                                   GtkTextChildAnchor   *anchor)
{
  DasherGtkTextViewChild *vc;
...
/**
 * dasher_gtk_text_view_add_child_in_window:
 * @text_view: a #DasherGtkTextView
 * @child: a #GtkWidget
 ...
 * dasher_gtk_text_view_set_border_window_size()).  Note that the child
 * coordinates are given relative to the #GdkWindow in question, and
 * that these coordinates have no sane relationship to scrolling. When
 * placing a child in #DASHER_GTK_TEXT_WINDOW_WIDGET, scrolling is
 * irrelevant, the child floats above all scrollable areas. But when
 * placing a child in one of the scrollable windows (border windows or
 * text window), you'll need to compute the child's correct position
 * in buffer coordinates any time scrolling occurs or buffer changes
 * occur, and then call dasher_gtk_text_view_move_child() to update the
 ...
 **/
void
dasher_gtk_text_view_add_child_in_window (DasherGtkTextView          *text_view,
                                   GtkWidget            *child,
                                   DasherGtkTextWindowType     which_window,
                                   gint                  xpos,
                                   gint                  ypos)
{
  DasherGtkTextViewChild *vc;
...
/**
 * dasher_gtk_text_view_move_child:
 * @text_view: a #DasherGtkTextView
 * @child: child widget already added to the text view
 * @xpos: new X position in window coordinates
 * @ypos: new Y position in window coordinates
 *
 * Updates the position of a child, as for dasher_gtk_text_view_add_child_in_window().
 * 
 **/
void
dasher_gtk_text_view_move_child          (DasherGtkTextView          *text_view,
                                   GtkWidget            *child,
                                   gint                  xpos,
                                   gint                  ypos)
{
...
/**
 * dasher_gtk_text_view_forward_display_line:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
dasher_gtk_text_view_forward_display_line (DasherGtkTextView *text_view,
                                    GtkTextIter *iter)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
  g_return_val_if_fail (iter != NULL, FALSE);
...
/**
 * dasher_gtk_text_view_backward_display_line:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
dasher_gtk_text_view_backward_display_line (DasherGtkTextView *text_view,
                                     GtkTextIter *iter)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
  g_return_val_if_fail (iter != NULL, FALSE);
...
/**
 * dasher_gtk_text_view_forward_display_line_end:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
dasher_gtk_text_view_forward_display_line_end (DasherGtkTextView *text_view,
                                        GtkTextIter *iter)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
  g_return_val_if_fail (iter != NULL, FALSE);
...
/**
 * dasher_gtk_text_view_backward_display_line_start:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 * 
 ...
 **/
gboolean
dasher_gtk_text_view_backward_display_line_start (DasherGtkTextView *text_view,
                                           GtkTextIter *iter)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
  g_return_val_if_fail (iter != NULL, FALSE);
...
/**
 * dasher_gtk_text_view_starts_display_line:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 * 
 * Determines whether @iter is at the start of a display line.
 * See dasher_gtk_text_view_forward_display_line() for an explanation of
 * display lines vs. paragraphs.
 * 
 * Return value: %TRUE if @iter begins a wrapped line
 **/
gboolean
dasher_gtk_text_view_starts_display_line (DasherGtkTextView       *text_view,
                                   const GtkTextIter *iter)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
  g_return_val_if_fail (iter != NULL, FALSE);
...
/**
 * dasher_gtk_text_view_move_visually:
 * @text_view: a #DasherGtkTextView
 * @iter: a #GtkTextIter
 ...
 **/
gboolean
dasher_gtk_text_view_move_visually (DasherGtkTextView *text_view,
                             GtkTextIter *iter,
                             gint         count)
{
  g_return_val_if_fail (DASHER_GTK_IS_TEXT_VIEW (text_view), FALSE);
...
#include "dashergtktextviewaliasdef.c"
