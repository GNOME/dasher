...
struct _DasherGtkTextViewClass
{
  ...
  void (* set_scroll_adjustments)   (DasherGtkTextView    *text_view,
                                     GtkAdjustment  *hadjustment,
                                     GtkAdjustment  *vadjustment);

  void (* populate_popup)           (DasherGtkTextView    *text_view,
                                     GtkMenu        *menu);
  
  /* These are all RUN_ACTION signals for keybindings */

  /* move insertion point */
  void (* move_cursor) (DasherGtkTextView    *text_view,
   ...
   * the freeze.
   */
  void (* page_horizontally) (DasherGtkTextView *text_view,
                              gint         count,
                              gboolean     extend_selection);
  ...
  /* Edits */
  void (* insert_at_cursor)      (DasherGtkTextView *text_view,
                                  const gchar *str);
  void (* delete_from_cursor)    (DasherGtkTextView  *text_view,
                                  GtkDeleteType type,
                                  gint          count);
  ...
  void (* move_focus)       (DasherGtkTextView     *text_view,
...
void           dasher_gtk_text_view_set_buffer            (DasherGtkTextView   *text_view,
                                                    GtkTextBuffer *buffer);
GtkTextBuffer *dasher_gtk_text_view_get_buffer            (DasherGtkTextView   *text_view);
gboolean       dasher_gtk_text_view_scroll_to_iter        (DasherGtkTextView   *text_view,
                                                    GtkTextIter   *iter,
                                                    gdouble        within_margin,
                                                    gboolean       use_align,
                                                    gdouble        xalign,
                                                    gdouble        yalign);
void           dasher_gtk_text_view_scroll_to_mark        (DasherGtkTextView   *text_view,
                                                    GtkTextMark   *mark,
                                                    gdouble        within_margin,
                                                    gboolean       use_align,
                                                    gdouble        xalign,
                                                    gdouble        yalign);
void           dasher_gtk_text_view_scroll_mark_onscreen  (DasherGtkTextView   *text_view,
                                                    GtkTextMark   *mark);
gboolean       dasher_gtk_text_view_move_mark_onscreen    (DasherGtkTextView   *text_view,
                                                    GtkTextMark   *mark);
gboolean       dasher_gtk_text_view_place_cursor_onscreen (DasherGtkTextView   *text_view);

void           dasher_gtk_text_view_get_visible_rect      (DasherGtkTextView   *text_view,
                                                    GdkRectangle  *visible_rect);
void           dasher_gtk_text_view_set_cursor_visible    (DasherGtkTextView   *text_view,
                                                    gboolean       setting);
gboolean       dasher_gtk_text_view_get_cursor_visible    (DasherGtkTextView   *text_view);

void           dasher_gtk_text_view_get_iter_location     (DasherGtkTextView   *text_view,
                                                    const GtkTextIter *iter,
                                                    GdkRectangle  *location);
void           dasher_gtk_text_view_get_iter_at_location  (DasherGtkTextView   *text_view,
                                                    GtkTextIter   *iter,
                                                    gint           x,
                                                    gint           y);
void           dasher_gtk_text_view_get_iter_at_position  (DasherGtkTextView   *text_view,
                                                    GtkTextIter   *iter,
						    gint          *trailing,
                                                    gint           x,
                                                    gint           y);
void           dasher_gtk_text_view_get_line_yrange       (DasherGtkTextView       *text_view,
                                                    const GtkTextIter *iter,
                                                    gint              *y,
                                                    gint              *height);

void           dasher_gtk_text_view_get_line_at_y         (DasherGtkTextView       *text_view,
                                                    GtkTextIter       *target_iter,
                                                    gint               y,
                                                    gint              *line_top);

void dasher_gtk_text_view_buffer_to_window_coords (DasherGtkTextView       *text_view,
                                            DasherGtkTextWindowType  win,
                                            gint               buffer_x,
                                            gint               buffer_y,
                                            gint              *window_x,
                                            gint              *window_y);
void dasher_gtk_text_view_window_to_buffer_coords (DasherGtkTextView       *text_view,
                                            DasherGtkTextWindowType  win,
                                            gint               window_x,
                                            gint               window_y,
                                            gint              *buffer_x,
...
GdkWindow*        dasher_gtk_text_view_get_window      (DasherGtkTextView       *text_view,
                                                 DasherGtkTextWindowType  win);
DasherGtkTextWindowType dasher_gtk_text_view_get_window_type (DasherGtkTextView       *text_view,
                                                 GdkWindow         *window);

void dasher_gtk_text_view_set_border_window_size (DasherGtkTextView       *text_view,
                                           DasherGtkTextWindowType  type,
                                           gint               size);
gint dasher_gtk_text_view_get_border_window_size (DasherGtkTextView       *text_view,
					   DasherGtkTextWindowType  type);

gboolean dasher_gtk_text_view_forward_display_line           (DasherGtkTextView       *text_view,
                                                       GtkTextIter       *iter);
gboolean dasher_gtk_text_view_backward_display_line          (DasherGtkTextView       *text_view,
                                                       GtkTextIter       *iter);
gboolean dasher_gtk_text_view_forward_display_line_end       (DasherGtkTextView       *text_view,
                                                       GtkTextIter       *iter);
gboolean dasher_gtk_text_view_backward_display_line_start    (DasherGtkTextView       *text_view,
                                                       GtkTextIter       *iter);
gboolean dasher_gtk_text_view_starts_display_line            (DasherGtkTextView       *text_view,
                                                       const GtkTextIter *iter);
gboolean dasher_gtk_text_view_move_visually                  (DasherGtkTextView       *text_view,
                                                       GtkTextIter       *iter,
                                                       gint               count);

/* Adding child widgets */
void dasher_gtk_text_view_add_child_at_anchor (DasherGtkTextView          *text_view,
                                        GtkWidget            *child,
                                        GtkTextChildAnchor   *anchor);

void dasher_gtk_text_view_add_child_in_window (DasherGtkTextView          *text_view,
                                        GtkWidget            *child,
...
void dasher_gtk_text_view_move_child          (DasherGtkTextView          *text_view,
                                        GtkWidget            *child,
                                        /* window coordinates */
                                        gint                  xpos,
                                        gint                  ypos);
...
void             dasher_gtk_text_view_set_wrap_mode          (DasherGtkTextView      *text_view,
                                                       GtkWrapMode       wrap_mode);
GtkWrapMode      dasher_gtk_text_view_get_wrap_mode          (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_editable           (DasherGtkTextView      *text_view,
                                                       gboolean          setting);
gboolean         dasher_gtk_text_view_get_editable           (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_overwrite          (DasherGtkTextView      *text_view,
						       gboolean          overwrite);
gboolean         dasher_gtk_text_view_get_overwrite          (DasherGtkTextView      *text_view);
void		 dasher_gtk_text_view_set_accepts_tab        (DasherGtkTextView	*text_view,
						       gboolean		 accepts_tab);
gboolean	 dasher_gtk_text_view_get_accepts_tab        (DasherGtkTextView	*text_view);
void             dasher_gtk_text_view_set_pixels_above_lines (DasherGtkTextView      *text_view,
                                                       gint              pixels_above_lines);
gint             dasher_gtk_text_view_get_pixels_above_lines (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_pixels_below_lines (DasherGtkTextView      *text_view,
                                                       gint              pixels_below_lines);
gint             dasher_gtk_text_view_get_pixels_below_lines (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_pixels_inside_wrap (DasherGtkTextView      *text_view,
                                                       gint              pixels_inside_wrap);
gint             dasher_gtk_text_view_get_pixels_inside_wrap (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_justification      (DasherGtkTextView      *text_view,
                                                       GtkJustification  justification);
GtkJustification dasher_gtk_text_view_get_justification      (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_left_margin        (DasherGtkTextView      *text_view,
                                                       gint              left_margin);
gint             dasher_gtk_text_view_get_left_margin        (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_right_margin       (DasherGtkTextView      *text_view,
                                                       gint              right_margin);
gint             dasher_gtk_text_view_get_right_margin       (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_indent             (DasherGtkTextView      *text_view,
                                                       gint              indent);
gint             dasher_gtk_text_view_get_indent             (DasherGtkTextView      *text_view);
void             dasher_gtk_text_view_set_tabs               (DasherGtkTextView      *text_view,
                                                       PangoTabArray    *tabs);
