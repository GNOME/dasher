...
extern "C" void about_dasher(GtkWidget *widget, gpointer user_data)
{
  ...
  gchar *authors[] = {
    ...
    "David Ward",
    "Brian Williams",
    "Yasser H. Abdel-Haleem (Arabic training text)",
    "Peter Baert (Dutch and French training texts)",
    "Johan Bouvin (Swedish training text)",
    "Gilles Brodeur (French training text)",
    "Behdad Esfahbod (Persian training text)",
    "Gilles-Maurice De Schryver (Training texts for various South African languages)",
    "Edmund Grimley Evans (Esperanto training text)",
    "Matteo Fasanella (Italian training text)",
    "Leena Krohn (Finnish training text)",
    "Michael Muhlhaus (German training text)",
    "Pantelis Nasikas (Greek training text)",
    "Blazej L. Popielski (Polish training text)",
    "Andrea Prado (Spanish training text)",
    "Nikon Rasumov (Russian Latin training text)",
    "Alban Rrustemi (Albanian training text)",
    "Martin Whittle (Brazilian Portugese training text)",
    "Ole Winther (Danish training text)",
    "Alex Ziranov (Russian training text)",
    NULL
  };
  ...
  gchar *documenters[] = {
    ...
    "Matthew Garrett",
    "David MacKay",
    "Hugh M. Allen (Norwegian website translation)",
    "Claudia V. Bourda (Spanish website translation)",
    "Radoslaw Cichocki (Polish website translation)",
    "Fabio Fonseca (Portugese website translation)",
    "Dan Witzner Hansen (Danish website translation)",
    "Andrew B. Kuliapin (Russian website translation)",
    "Xiaoying Liang (Chinese website translation)",
    "Simone Mangano (Italian website translation)",
    "Christoforos Moutafis (Greek website translation)",
    "Julius Roelcke (German website translation)",
    "Louis Tan (Dutch website translation)",
    "Marc Xhrouet (French website translation)",
    NULL
  };
