...
template<typename T>
CSimplePooledAlloc<T>::CSimplePooledAlloc(size_t iSize) : m_iBlockSize(iSize), m_iCurrent(0)
{
...
template<typename T>
CSimplePooledAlloc<T>::~CSimplePooledAlloc()
{
