...
public:
  ...
  virtual LRESULT WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam, bool & bProcessed);
};

/////////////////////////////////////////////////////////////////////////////

inline LRESULT CALLBACK CWindow::BaseWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
  ...
  CWindow *pObj = (CWindow *) GetWindowLong(hwnd, GWL_USERDATA);
