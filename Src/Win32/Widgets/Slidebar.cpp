//////////////////////////////////////////////////////////////////////
// slidebar.cpp: Implementation of the Slide bar
// Copyright 2002 Iain Murray, Inference Group, Cavendish, Cambridge.
//////////////////////////////////////////////////////////////////////
...
{
	// The edit box
	SB_edit = CreateWindowEx(WS_EX_CLIENTEDGE, TEXT("EDIT"), TEXT(""),
		WS_CHILD | WS_VISIBLE | WS_TABSTOP | WS_GROUP | ES_READONLY,
		0, 0, 0, CW_USEDEFAULT, m_hwnd, NULL, WinHelper::hInstApp, NULL);
	...
	: Visible(Visible)
{
	...
	m_hwnd = CreateWindowEx(WS_EX_CONTROLPARENT,
		TEXT("STATIC"), MaxSpeed.c_str(),
		WS_CHILD | WS_TABSTOP,
		0, 0, 0, 0, ParentWindow, NULL, WinHelper::hInstApp, NULL);
