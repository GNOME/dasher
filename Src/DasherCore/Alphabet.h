...
public:
	...
	int GetNumberSymbols() const { return m_NumAlphabetSymbols;}        // return size of alphabet
	...
	void AlphabetComplete();                      // indicate that the entire alphabet has been loaded
...
protected:
	...
	void SetControlSymbol() {m_ControlSymbol=m_Characters.size()-1;}
...
private:
	...
	int m_NumAlphabetSymbols;              // number of symbols in the alphabet
