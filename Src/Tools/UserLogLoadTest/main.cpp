 ...
 */
	    ...
	    if (pAlphIO == NULL)
	    {
		    gLogger->Log("Failed to create alphIO from '%s'", logNORMAL, strAlphabetFilename.c_str());
		    return 0;
	    }
	    ...
	    if (pAlphabet == NULL)
	    {
		    gLogger->Log("Failed to create alphabet from '%s'", logNORMAL, strAlphabetName.c_str());
		    return 0;
	    }
